...
export default siteConfig({
  ...
  rootNotionPageId: 'Home-Busines-0b241572f53745ce80ab8932875b2454',
  // if you want to restrict pages to a single notion workspace (optional)
  // (this should be a Notion ID; see the docs for how to extract this)
  rootNotionSpaceId: null,

  // basic site info (required)
  name: 'Home Business Academy - Earn Online - Work From Anywhere',
  domain: 'Homebusiness.edu.vn',
  author: 'Mr Chuyen TNCshare',
  ...
  facebook: 'https://www.facebook.com/groups/tncshare',
  // mastodon: '#', // optional mastodon profile URL, provides link verification
  // newsletter: '#', // optional newsletter URL
  youtube: 'channel/UC2Vn_n1968bI7KtzV-gsgrQ', // optional youtube channel name or `channel/UCGbXXXXXXXXXXXXXXXXXXXXXX`
